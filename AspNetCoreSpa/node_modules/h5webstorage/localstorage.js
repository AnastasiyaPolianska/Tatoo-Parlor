 ...
 */
exports.LOCAL_STORAGE_OBJECT = new core_1.OpaqueToken("localstorage");
/**
...
var LocalStorage = (function (_super) {
    ...
    function LocalStorage(ngZone, storage, transformer, options) {
        _super.call(this, ngZone, storage, transformer, options);
    }
    LocalStorage = __decorate([
        core_1.Injectable(),
        __param(1, core_1.Inject(exports.LOCAL_STORAGE_OBJECT)),
