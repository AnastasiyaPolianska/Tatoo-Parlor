import { NgZone, OnDestroy, OpaqueToken } from "@angular/core";
/**
 ...
 */
export declare let STORAGE_OPTIONS: OpaqueToken;
/**
 ...
 */
export declare let SERDES_OBJECT: OpaqueToken;
/**
 ...
 */
export declare abstract class BaseStorage implements OnDestroy, Storage {
    /**
    ...
    private normalizeStorageKey(name, dir);
