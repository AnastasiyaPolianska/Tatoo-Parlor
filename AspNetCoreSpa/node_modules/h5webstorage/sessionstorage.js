 ...
 */
exports.SESSION_STORAGE_OBJECT = new core_1.OpaqueToken("sessionstorage");
/**
...
var SessionStorage = (function (_super) {
    ...
    function SessionStorage(ngZone, storage, transformer, options) {
        _super.call(this, ngZone, storage, transformer, options);
    }
    SessionStorage = __decorate([
        core_1.Injectable(),
        __param(1, core_1.Inject(exports.SESSION_STORAGE_OBJECT)),
        __param(2, core_1.Inject(basestorage_1.SERDES_OBJECT)),
        __param(3, core_1.Inject(basestorage_1.STORAGE_OPTIONS)),
        __param(3, core_1.Optional()), 
        __metadata('design:paramtypes', [core_1.NgZone, Storage, Object, Object])
    ], SessionStorage);
